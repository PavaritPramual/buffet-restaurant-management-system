...
public final class OrderingModels {
    ...
    public record MenuItem(Long id, Long categoryId, String name, boolean available, Set<Long> packageIds) {}
    ...
    public record MenuItemRequest(@NotNull @Positive Long categoryId, @NotBlank String name,
                                  boolean available, @NotEmpty Set<@Positive Long> packageIds) {}
